...
public class PayloadContext implements PayloadContextIf {
	 ...
	 * strategy
	 */
	private PayloadStrategyIf strategy = new PayloadStrategyTb();

	public KuraMessage create(String asset) {
		return strategy.createMessage(asset);
	}
	...
	public String toString() {
		if (strategy instanceof PayloadStrategyTb)
