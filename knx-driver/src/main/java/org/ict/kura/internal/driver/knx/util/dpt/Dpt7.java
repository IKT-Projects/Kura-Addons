...
public class Dpt7 extends Dpt {
	/* The logger instance */
	private static final Logger LOGGER = LoggerFactory.getLogger(Dpt7.class);

	public Dpt7(DPTXlator2ByteUnsigned dptXlator) throws KNXFormatException {
	...
	public String from(KnxBindingConfig knxBindingConfig, ThingChannelListener thingChannelListenerImpl,
		 ...
		 * (only require2-Octet Unsigned Value, DPT 7.xxx)
		 */
	...
	public String toString() {
		return "Dpt7 [getDptXlator()=" + getDptXlator() + "]";
	}
}
