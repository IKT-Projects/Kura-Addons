...
public class Dpt14 extends Dpt {
	/* The logger instance */
	private static final Logger LOGGER = LoggerFactory.getLogger(Dpt14.class);

	public Dpt14(DPTXlator4ByteFloat dptXlator) throws KNXFormatException {
	...
	public String from(KnxBindingConfig knxBindingConfig, ThingChannelListener thingChannelListenerImpl,
		...
		/*
		 * Adds the new value property, no conversion necessary (require 4-Octet Float
		 * Value, DPT 14.xxx)
		 */
		jsonObject.addProperty(thingChannelListenerImpl.getPropertyName(), this.getDptXlator().getNumericValue());
	...
	public String toString() {
		return "Dpt14 [getDptXlator()=" + getDptXlator() + "]";
	}
}
