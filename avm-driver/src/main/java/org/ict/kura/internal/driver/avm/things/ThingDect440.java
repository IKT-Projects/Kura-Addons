...
import static org.ict.kura.internal.driver.avm.things.util.InteractionProperties.createHumidityProperty;
...
public class ThingDect440 {
	private Thing thing;

	public ThingDect440(String href, String thingID, String titel, String description, String ain) throws MalformedURLException {
		this.thing = createThing(href, thingID, titel, description, ain);
	}

	private Thing createThing(String href, String thingID, String titel, String description, String ain) throws MalformedURLException {
		...
		PropertyAffordance humidity = createHumidityProperty(uri.toString(), "humidity");
		humidity.getForms().get(0).setAdditionalProperties(bindings);
